 ...
 * #### Note:
 *
 *  - The array syntax `.sort([['field', 1], ['test', -1]])` can only be used with [mongodb driver >= 2.0.46](https:
 *  - Cannot be used with `distinct()`
 *
 ...
 *
 *     new Query().setReadPreference('primary')
 *
 * #### Preferences:
 *
 ...
 * @memberOf Query
 * @instance
 * @param {String|number|object} concern 0 for fire-and-forget, 1 for acknowledged by one server, 'majority' for majority of the replica set, or [any of the more advanced options](https:
 * @see mongodb https:
 * @return {Query} this
 * @api public
 */
 ...
 *
 *     await query.findOne({ name: /^Burning/ });
 *
...
/**
 * Issues a mongodb [findAndModify](http:
 *
 ...
 * #### Examples:
 *
 *     await query.findOneAndUpdate(conditions, update, options)
 *     query.findOneAndUpdate(conditions, update, options)
 *     await query.findOneAndUpdate(conditions, update)
 ...
 * #### Examples:
 *
 *     await A.where().findOneAndRemove(conditions, options)
 *     A.where().findOneAndRemove(conditions, options)
 *     await A.where().findOneAndRemove(conditions)
