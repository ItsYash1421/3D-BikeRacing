 ...
 *     console.log(m.email)
 *     M.find({ email: 'SomeEmail@example.com' });
 *
...
/**
 * Adds an uppercase [setter](https:
 *
 * #### Example:
 *
...
/**
 * Adds a trim [setter](https:
 *
 * The string value will be [trimmed](https:
 *
 * #### Example:
 *
