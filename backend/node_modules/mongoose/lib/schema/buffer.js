 ...
 *     new User({ }).validateSync().errors.test.message;
 *
 ...
 *     typeof (new Model({ buf: Buffer.fromString('hello') }).buf);
 *
 ...
 *     new M({ buf: Buffer.from('') }).validateSync();
 *
 * @param {Function} fn
 * @return {Function}
...
/**
 * Sets the default [subtype](https:
 * for this buffer. You can find a [list of allowed subtypes here](https:
 *
 * #### Example:
 *
