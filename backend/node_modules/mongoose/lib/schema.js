 ...
 * - [autoIndex](https:
 * - [autoCreate](https:
 * - [bufferCommands](https:
 * - [bufferTimeoutMS](https:
 * - [capped](https:
 * - [collection](https:
 * - [discriminatorKey](https:
 * - [id](https:
 * - [_id](https:
 * - [minimize](https:
 * - [read](https:
 ...
 * - [toObject](https:
 * - [typeKey](https:
 * - [validateBeforeSave](https:
 * - [validateModifiedOnly](https:
 * - [versionKey](https:
 * - [optimisticConcurrency](https:
 * - [collation](https:
 * - [timeseries](https:
 * - [selectPopulatedPaths](https:
 * - [skipVersioning](https:
 * - [timestamps](https:
 * - [pluginTags](https:
 * - [virtuals](https:
 * - [collectionOptions]: object with options passed to [`createCollection()`](https:
 * - [encryptionType]: the encryption type for the schema.  Valid options are `csfle` or `queryableEncryption`.  See https:
 *
 ...
 *     console.log(schema.virtuals['answer'].getters[0].call());
 *
 * @api public
 * @property virtuals
 * @memberOf Schema
 ...
 *
 * This method is analagous to [Lodash's `pick()` function](https:
 *
 * #### Example:
 *
 ...
 *
 * This method is analagous to [Lodash's `omit()` function](https:
 *
 * #### Example:
 *
 *     const schema = Schema({ name: String, age: Number });
 ...
 *
 *     Event.discriminators['clicked'];
 *
 *     const doc = await Event.create({ kind: 'clicked', element: '#hero' });
 *     doc.element;
 *     doc instanceof ClickedModel;
 *
...
/**
 * Add an [Atlas search index](https:
 ...
 *     fizz.scratch();
 *
 * NOTE: `Schema.method()` adds instance methods to the `Schema.methods` object. You can also add instance methods directly to the `Schema.methods` object as seen in the [guide](https:
 *
 ...
 * @param {Object} [options] Options to pass to [MongoDB driver's `createIndex()` function](https:
 * @param {String | number} [options.expires=null] Mongoose-specific syntactic sugar, uses [ms](https:
 ...
 * @param {Object} [options]
 * @param {String|Model} [options.ref] model name or model instance. Marks this as a [populate virtual](https:
 * @param {String|Function} [options.localField] Required for populate virtuals. See [populate virtual docs](https:
 * @param {String|Function} [options.foreignField] Required for populate virtuals. See [populate virtual docs](https:
 * @param {Boolean|Function} [options.justOne=false] Only works with populate virtuals. If [truthy](https:
 * @param {Boolean} [options.count=false] Only works with populate virtuals. If [truthy](https:
 * @param {Function|null} [options.get=null] Adds a [getter](https:
 * @param {Object|Function} [options.match=null] Apply a default [`match` option to populate](https:
...
/**
 * Loads an ES6 class into a schema. Maps [setters](https:
 * and [instance methods](https:
 * to schema [virtuals](https:
 * [statics](https:
 * [methods](https:
 *
 * #### Example:
 ...
 *
 * By default, returns normal [JSON schema representation](https:
 * [MongoDB's `$jsonSchema` collection option](https:
