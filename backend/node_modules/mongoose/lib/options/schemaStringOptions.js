...
/**
 * If truthy, Mongoose will add a [custom setter](https:
...
/**
 * If truthy, Mongoose will add a [custom setter](https:
 * whitespace using [JavaScript's built-in `String#trim()`](https:
 *
 * @api public
 * @property trim
 * @memberOf SchemaStringOptions
 ...
 * using JavaScript's built-in [`String#toUpperCase()`](https:
 *
 * @api public
 * @property uppercase
 * @memberOf SchemaStringOptions
...
/**
 * Sets default [populate options](https:
 *
 * @api public
 * @property populate
 * @memberOf SchemaStringOptions
