 ...
 *     schema.path('name').options instanceof mongoose.SchemaTypeOptions;
 *
 * @api public
 ...
 * model is compiled. [The `unique` option is **not** a validator](https:
 *
 * @api public
 * @property unique
 * @memberOf SchemaTypeOptions
 ...
 * is saved to the database for the first time. Read more about [immutability in Mongoose here](https:
 *
 * @api public
 * @property immutable
 * @memberOf SchemaTypeOptions
