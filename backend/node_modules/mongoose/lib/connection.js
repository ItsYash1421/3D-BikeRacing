 ...
 * added to this connection using [`Connection#model()`](https:
 *
 * #### Example:
 *
 ...
 *
 *     Object.keys(conn.models).length;
 *     conn.models.Test === Test;
 *
 * @property models
 * @memberOf Connection
 * @instance
 ...
 * you have [multiple connections](https:
 *
 * #### Example:
 *
 *
 ...
 * and [views](https:
 *
 * Options are passed down without modification to the [MongoDB driver's `createCollection()` function](https:
 *
 ...
 *
 *     await db.bulkWrite([
 *       { model: Test, name: 'insertOne', document: { name: 'test1' } },
 ...
 *
 * Calls the MongoDB driver's [`session.withTransaction()`](https:
 ...
 * @param {Object} [options] Passed on to [`MongoClient.connect`](https:
 ...
 * @see Connection#readyState https:
 *
 * @method on
 * @instance
 * @memberOf Connection
...
/**
 * Destroy the connection. Similar to [`.close`](https:
 ...
 * This method returns a thin wrapper around a [MongoDB Node.js driver collection]([MongoDB Node.js driver collection](https:
 * Using a Collection bypasses Mongoose middleware, validation, and casting,
 * letting you use [MongoDB Node.js driver](https:
 *
 ...
 * @param {Object} [options] passed without changes to [the MongoDB driver's `Db#watch()` function](https:
...
/**
 * Returns the [MongoDB driver `MongoClient`](https:
...
/**
 * Set the [MongoDB driver `MongoClient`](https:
...
/**
 * Switches to a different database using the same [connection pool](https:
 *
 ...
 * @param {Boolean} [options.noListener=false] If true, the connection object will not make the db listen to events on the original connection. See [issue #9961](https:
 * @return {Connection} New Connection Object
 * @api public
 */

/**
 * Runs a [db-level aggregate()](https:
 *
 * @method aggregate
 * @memberOf Connection
 * @param {Array} pipeline
