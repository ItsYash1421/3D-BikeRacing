 ...
 * instantiate this class directly, use [Model.aggregate()](https:
 *
 * #### Example:
 *
...
/**
 * Contains options passed down to the [aggregate command](https:
 ...
 *
 * Mongoose query [selection syntax](https:
 *
 * #### Example:
 *
 *
 ...
 *
 * @see $unwind https:
 * @param {String|Object|String[]|Object[]} fields the field(s) to unwind, either as field names or as [objects with options](https:
 * @return {Aggregate}
 * @api public
 */
...
/**
 * Sets the session for this aggregation. Useful for [transactions](https:
 *
 * #### Example:
 *
 ...
 * @param {Number} [options.maxTimeMS] number limits the time this aggregation will run, see [MongoDB docs on `maxTimeMS`](https:
 ...
 * @param {Object} [options.collation] object see [`Aggregate.prototype.collation()`](https:
 * @param {ClientSession} [options.session] ClientSession see [`Aggregate.prototype.session()`](https:
 * @see mongodb https:
 * @return {Aggregate} this
 * @api public
 */
