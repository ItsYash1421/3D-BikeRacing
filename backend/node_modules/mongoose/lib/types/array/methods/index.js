...
const methods = {
   ...
   * _This update is implemented using the MongoDB [$pop](https:
   *
   *      doc.array = [1,2,3];
   *
   ...
   * [the `Document.equals()` function.](https:
   *
   * #### Example:
   *
   ...
   * @method sort
   * @memberOf MongooseArray
   * @see MasteringJS: Array sort https:
   */
   ...
   * @method splice
   * @memberOf MongooseArray
   * @see MasteringJS: Array splice https:
   */
