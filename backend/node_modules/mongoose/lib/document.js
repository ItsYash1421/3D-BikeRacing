 ...
 * @inherits NodeJS EventEmitter https:
 ...
 * using `findOne()` or another [query operation](https:
 * `$isNew` will be false.
 *
 * #### Example:
 *
 ...
 * #### Note:
 *
 * This getter exists on all documents by default. The getter can be disabled by setting the `id` [option](https:
 *
 *     new Schema({ name: String }, { id: false });
 *
 * @api public
 * @see Schema options https:
 * @property id
 * @memberOf Document
 * @instance
 */
 ...
 *
 * This function triggers `init` [middleware](https:
 * Note that `init` hooks are [synchronous](https:
 *
 ...
 * #### Valid options:
 *
 *  - same as in [Model.updateOne](https:
 *
 * @see Model.updateOne https:
 * @param {Object} update
 ...
 * #### Valid options:
 *
 *  - same as in [Model.replaceOne](https:
 *
 ...
 * @param {Boolean} [options.merge=false] if true, setting a [nested path](https:
 * @return {Document} this
 * @method $set
 * @memberOf Document
 * @instance
 ...
 *
 * _Very helpful when using [Mixed](https:
 *
 * #### Example:
 *
 ...
 * #### Note:
 *
 * This method is called `pre` save and if a validation rule is violated, [save](https:
 *
 * #### Example:
 *
...
/**
 * Converts this document into a plain-old JavaScript object ([POJO](https:
 *
 * Buffers are converted to instances of [mongodb.Binary](https:
 *
 * #### Getters/Virtuals
 *
 ...
 *
 * To apply these options to every document of your schema by default, set your [schemas](https:
 *
 ...
 *
 * Transforms, like all of these options, are also available for `toJSON`. See [this guide to `JSON.stringify()`](https:
 *
 * See [schema options](https:
 *
...
/**
 * The return value of this method is used in calls to [`JSON.stringify(doc)`](https:
 *
 * This method accepts the same options as [Document#toObject](https:
 *
 *     schema.set('toJSON', { virtuals: true });
 *
 * There is one difference between `toJSON()` and `toObject()` options.
 * When you call `toJSON()`, the [`flattenMaps` option](https:
 * When you call `toObject()`, the `flattenMaps` option is `false` by default.
 *
 * See [schema options](https:
 *
 * @param {Object} options
 * @param {Boolean} [options.flattenMaps=true] if true, convert Maps to [POJOs](https:
 * @param {Boolean} [options.flattenObjectIds=false] if true, convert any ObjectIds in the result to 24 character hex strings.
 ...
 * @return {Object}
 * @see Document#toObject https:
 * @see JSON.stringify() in JavaScript https:
 * @api public
 * @memberOf Document
 * @instance
 */
 ...
 *
 * This method is especially useful when writing [custom transaction wrappers](https:
 *
 * #### Example:
 *
 *     const doc = await TestModel.findOne();
