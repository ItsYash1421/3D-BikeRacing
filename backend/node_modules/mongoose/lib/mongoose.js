 ...
 *
 * @api public
 * @param {Object} options see [`Mongoose#set()` docs](https:
 */
 ...
 *
 *     mongoose.set({ debug: true, autoIndex: false });
 *
 ...
 * - `autoCreate`: Set to `true` to make Mongoose call [`Model.createCollection()`](https:
 ...
 * - `timestamps.createdAt.immutable`: `true` by default. If `false`, it will change the `createdAt` field to be [`immutable: false`](https:
 * - `maxTimeMS`: If set, attaches [maxTimeMS](https:
 * - `objectIdGetter`: `true` by default. Mongoose adds a getter to MongoDB ObjectId's called `_id` that returns `this` for convenience with populate. Set this to false to remove the getter.
 * - `overwriteModels`: Set to `true` to default to overwriting models with the same name when calling `mongoose.model()`, as opposed to throwing an `OverwriteModelError`.
 * - `returnOriginal`: If `false`, changes the default `returnOriginal` option to `findOneAndUpdate()`, `findByIdAndUpdate`, and `findOneAndReplace()` to false. This is equivalent to setting the `new` option to `true` for `findOneAndX()` calls by default. Read our [`findOneAndUpdate()` tutorial](https:
 * - `runValidators`: `false` by default. Set to true to enable [update validators](https:
 * - `sanitizeFilter`: `false` by default. Set to true to enable the [sanitization of the query filters](https:
 * - `selectPopulatedPaths`: `true` by default. Set to false to opt out of Mongoose adding all fields that you `populate()` to your `select()`. The schema-level option `selectPopulatedPaths` overwrites this one.
 * - `strict`: `true` by default, may be `false`, `true`, or `'throw'`. Sets the default strict mode for schemas.
 * - `strictQuery`: `false` by default. May be `false`, `true`, or `'throw'`. Sets the default [strictQuery](https:
 * - `toJSON`: `{ transform: true, flattenDecimals: true }` by default. Overwrites default objects to [`toJSON()`](https:
 * - `toObject`: `{ transform: true, flattenDecimals: true }` by default. Overwrites default objects to [`toObject()`](https:
 *
 ...
 *     await db.openUri('mongodb:
 *
 * @param {String} uri mongodb URI to connect to
 * @param {Object} [options] passed down to the [MongoDB driver's `connect()` function](https:
 * @param {Boolean} [options.bufferCommands=true] Mongoose specific option. Set to false to [disable buffering](https:
 ...
 * starts a session on the [default mongoose connection](https:
 *
 ...
 *     conn.model('Actor') === Actor;
 *     conn.model('Actor', schema) === Actor;
 *     conn.model('Actor', schema, 'actors') === Actor;
 *
 *
...
/**
 * The Mongoose module's default connection. Equivalent to `mongoose.connections[0]`, see [`connections`](https:
 *
 * #### Example:
 *
 *     const mongoose = require('mongoose');
 ...
 *
 * This is the connection used by default for every model created using [mongoose.model](https:
 *
 * To create a new connection, use [`createConnection()`](https:
 *
 * @memberOf Mongoose
 * @instance
 ...
 *     mongoose.connections[0] === mongoose.connection;
 *
...
/**
 * The Mongoose [VirtualType](https:
 *
 * @method VirtualType
 * @api public
 */
...
/**
 * The Mongoose ObjectId [SchemaType](https:
 * declaring paths in your schema that should be
 * [MongoDB ObjectIds](https:
 ...
 *
 *     mongoose.isValidObjectId({ test: 42 });
 *
 ...
 *     mongoose.isObjectIdOrHexString(new User({ name: 'test' }));
 *     mongoose.isObjectIdOrHexString({ test: 42 });
 *
...
/**
 * The Mongoose Decimal128 [SchemaType](https:
 * declaring paths in your schema that should be
 * [128-bit decimal floating points](https:
...
/**
 * The Mongoose Mixed [SchemaType](https:
...
/**
 * The Mongoose Date [SchemaType](https:
 *
 * #### Example:
 *
...
/**
 * The Mongoose Number [SchemaType](https:
...
/**
 * Sanitizes query filters against [query selector injection attacks](https:
...
/**
 * Tells `sanitizeFilter()` to skip the given object when filtering out potential [query selector injection attacks](https:
